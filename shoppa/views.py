...
def home(request):
    ...
    return render(request, 'home.html', {'login_form': login, "register_form": register, "open_login": open_login, "discounted_products": discounted_list, "domain": current_site, "cart_details": "cart_details", "cart_total": sub_total})
